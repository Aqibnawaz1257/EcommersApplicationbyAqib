...
import 'package:aqibecomappuseingfirebase/Address/addAddress.dart';
import 'package:aqibecomappuseingfirebase/Store/Search.dart';
import 'package:aqibecomappuseingfirebase/Store/cart.dart';
import 'package:aqibecomappuseingfirebase/Orders/myOrders.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: (){
                    EcommerceApp.auth.signOut().then((e){
